...
export const getServerSideProps = async ({ req, query }) => {
    ...
    const {conference, linkedConference} = await fetchAPIWithToken(`/conference-santes/${query.id}`, req.cookies.jwt)
    return { props: {conference, linkedConference} }
  }


const HealthConferences1 = ({conference, linkedConference}) => {
