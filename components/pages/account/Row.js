    ...
    <div>
      ...
      <div
        className={`px-6 md:px-24 ${
          ...
          type === 'filter'
            ? 'mt-4 flex flex-col md:mt-8 lg:grid lg:grid-cols-[repeat(4,minmax(_288px,_1fr))] xl:grid-cols-[repeat(4,minmax(_224px,_1fr))] 2xl:grid-cols-[repeat(4,minmax(_288px,_1fr))]'
            : type === 'grid'
